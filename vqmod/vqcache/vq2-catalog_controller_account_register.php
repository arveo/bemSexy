	...
	private $error = array();
  	...
  	public function index() {
        ...
        if (isset($this->error['sex'])) {
  		...
  		if (isset($this->error['complement'])) {
			$this->data['error_complement'] = $this->error['complement'];
		} else {
			$this->data['error_complement'] = '';
		}
		...
		if (isset($this->request->post['complement'])) {
    		$this->data['complement'] = $this->request->post['complement'];
		} else {
  	...
  	private function validate() {
		...
		if ($customer_group) {	
			...
			// Company ID
			if ($customer_group['company_display'] && $customer_group['company_required'] && !$this->request->post['company_id']) {
