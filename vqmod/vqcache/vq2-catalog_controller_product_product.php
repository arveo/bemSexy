...
$this->language->load('ati/transparent_products');
			...
			$this->data['ati_tp_related_opacity'] = $this->language->get('ati_tp_related_opacity');
...
$this->data['estoque'] = $product_info['quantity'];
