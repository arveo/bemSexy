...
class ModelSaleCustomerGroup extends Model {
	public function addCustomerGroup($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer_group SET approval = '" . (int)$data['approval'] . "', company_id_display = '" . (int)$data['company_id_display'] . "', company_id_required = '" . (int)$data['company_id_required'] . "', company_display = '" . (int)$data['company_display'] . "', company_required = '" . (int)$data['company_required'] . "', tax_id_display = '" . (int)$data['tax_id_display'] . "', tax_id_required = '" . (int)$data['tax_id_required'] . "', ie_display = '" . (int)$data['ie_display'] . "', ie_required = '" . (int)$data['ie_required'] . "', rg_display = '" . (int)$data['rg_display'] . "', rg_required = '" . (int)$data['rg_required'] . "', birth_date_display = '" . (int)$data['birth_date_display'] . "', birth_date_required = '" . (int)$data['birth_date_required'] . "', sex_display = '" . (int)$data['sex_display'] . "', sex_required = '" . (int)$data['sex_required'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
