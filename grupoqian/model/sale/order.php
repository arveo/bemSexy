	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
                ...
                'birth_date'              => $order_query->row['birth_date'],
                'sex'                     => $order_query->row['sex'],
				...
				'company_id'              => $order_query->row['payment_company_id'],
				'tax_id'                  => $order_query->row['payment_tax_id'],
                'ie'                      => $order_query->row['payment_ie'],
				'rg'                      => $order_query->row['payment_rg'],
				'payment_address_1'       => $order_query->row['payment_address_1'],
                'payment_number'          => $order_query->row['payment_number'],
                'payment_complement'      => $order_query->row['payment_complement'],
                ...
                'shipping_number'         => $order_query->row['shipping_number'],
                'shipping_complement'     => $order_query->row['shipping_complement'],
