...
class ModelBlogCategory extends Model {
   public function addCategory($data) {
      $this->db->query("INSERT INTO " . DB_PREFIX . "blog_category SET parent_id = '" . (int)$data['parent_id'] . "', image = '" . $this->db->escape($data['image']) . "', sort_order = '" . (int)$data['sort_order'] . "', article_order = '" . $this->db->escape($data['article_order']) . "', width = '" . (int)$data['width'] . "', height = '" . (int)$data['height'] . "', desc_limit = '" . (int)$data['desc_limit'] . "', status = '" . (int)$data['status'] . "', suffix = '" . $this->db->escape($data['suffix']) . "', created = CURDATE(), modified = CURDATE()");
   ...
   public function editCategory($category_id, $data) {
      $this->db->query("UPDATE " . DB_PREFIX . "blog_category SET parent_id = '" . (int)$data['parent_id'] . "', image = '" . $this->db->escape($data['image']) . "', sort_order = '" . (int)$data['sort_order'] . "', article_order = '" . $this->db->escape($data['article_order']) . "', width = '" . (int)$data['width'] . "', height = '" . (int)$data['height'] . "', desc_limit = '" . (int)$data['desc_limit'] . "', status = '" . (int)$data['status'] . "', suffix = '" . $this->db->escape($data['suffix']) . "', modified = CURDATE() WHERE category_id = '" . (int)$category_id . "'");
