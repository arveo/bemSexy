...
<style type="text/css">
    ...
    .button button {
        background: url("view/image/button-right.png") no-repeat scroll right top transparent;
        color: #FFFFFF;
        display: block;
            ...
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="button"><button type="submit" name="tags" value="tags"><?php echo $generate;?></button></div><br/>
