        ...
        <div id="tab-customer" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              ...
              <td class="left"><select id="customer_group_id" <?php echo ($customer_id); ?>>
            ...
            <tr id="company-id-display">
              ...
              <td><input type="text" name="company_id" value="<?php echo $payment_company_id; ?>" id="cnpj"/>
            ...
            <tr id="tax-id-display">
              ...
              <td><input type="text" name="tax_id" value="<?php echo $payment_tax_id; ?>" id="cpf"/>
                <?php if ($error_tax_id) { ?>
            ...
            <tr id="ie-display">
              ...
              <td><input type="text" name="ie" value="<?php echo $payment_ie; ?>" />
                <?php if ($error_ie) { ?>
                <span class="error"><?php echo $error_ie; ?></span>
                <?php } ?></td>
            <tr id="rg-display">
              <td><span id="rg-required" class="required">*</span> <?php echo $entry_rg; ?></td>
              <td><input type="text" name="rg" value="<?php echo $payment_rg; ?>" />
                <?php if ($error_rg) { ?>
        ...
        <div id="tab-payment" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="payment_postcode" value="<?php echo $payment_postcode; ?>" id="postcode"/>
            ...
            <tr>
              ...
              <td><input type="text" name="payment_number" value="<?php echo $payment_number; ?>" />
                <?php if ($error_payment_number) { ?>
                <span class="error"><?php echo $error_payment_number; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_complement; ?></td>
              <td><input type="text" name="payment_complement" value="<?php echo $payment_complement; ?>" /></td>
            </tr>
            <tr>
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="shipping_postcode" value="<?php echo $shipping_postcode; ?>" id="postcode"/>
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_number; ?></td>
              <td><input type="text" name="shipping_number" value="<?php echo $shipping_number; ?>" />
                <?php if ($error_shipping_number) { ?>
                <span class="error"><?php echo $error_shipping_number; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_complement; ?></td>
              <td><input type="text" name="shipping_complement" value="<?php echo $shipping_complement; ?>" /></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_address_2; ?></td>
...
$('input[name=\'customer\']').catcomplete({
	...
	select: function(event, ui) { 
        ...
        $('input[name=\'company\']').attr('value', ui.item['company']);
        $('input[name=\'company_id\']').attr('value', ui.item['company_id']);
        $('input[name=\'tax_id\']').attr('value', ui.item['tax_id']);
        $('input[name=\'ie\']').attr('value', ui.item['ie']);
        $('input[name=\'rg\']').attr('value', ui.item['rg']);
        $('input[name=\'birth_date\']').attr('value', ui.item['birth_date']);
        $('select[name=\'sex\']').attr('value', ui.item['sex']);
		...
		for (i in  ui.item['address']) {
			html += '<option value="' + ui.item['address'][i]['address_id'] + '">' + ui.item['address'][i]['company'] + ' ' + ui.item['address'][i]['firstname'] + ' ' + ui.item['address'][i]['lastname'] + ', ' + ui.item['address'][i]['address_1'] + ', ' + ui.item['address'][i]['number'] + ' - ' + ui.item['address'][i]['complement'] + ', ' + ui.item['address'][i]['city'] + ', ' + ui.item['address'][i]['country'] + '</option>';
	...
	$.ajax({
		...
		success: function(json) {
			if (json != '') {	
                ...
                $('input[name=\'payment_complement\']').attr('value', json['complement']);
	...
	$.ajax({
		...
		success: function(json) {
			if (json != '') {	
                ...
                $('input[name=\'shipping_number\']').attr('value', json['number']);
                $('input[name=\'shipping_complement\']').attr('value', json['complement']);
