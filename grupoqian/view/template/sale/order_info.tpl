    ...
    <div class="content">
      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            ...
            <td><?php echo $payment_ie; ?></td>
          </tr>
          <?php } ?>
          <?php if ($payment_rg) { ?>
          <tr>
            <td><?php echo $text_rg; ?></td>
            <td><?php echo $payment_rg; ?></td>
          </tr>
          <?php } ?>
          <tr>
      ...
      <div id="tab-payment" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            <td><?php echo $text_number; ?></td>
            <td><?php echo $payment_number; ?></td>
          </tr>
          <?php if ($payment_complement) { ?>
          <tr>
            <td><?php echo $text_complement; ?></td>
            <td><?php echo $payment_complement; ?></td>
          </tr>
          <?php } ?>
