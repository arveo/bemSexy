          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><?php if ($config_company) { ?>
                <input type="radio" name="config_company" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_company" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_company" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_company" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
