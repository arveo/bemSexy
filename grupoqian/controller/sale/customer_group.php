...
class ControllerSaleCustomerGroup extends Controller {
	...
	private function getForm() {
        ...
        $this->data['entry_ie_display'] = $this->language->get('entry_ie_display');
		$this->data['entry_ie_required'] = $this->language->get('entry_ie_required');
		$this->data['entry_rg_display'] = $this->language->get('entry_rg_display');
		$this->data['entry_rg_required'] = $this->language->get('entry_rg_required');
		$this->data['entry_sort_order'] = $this->language->get('entry_sort_order');
        $this->data['entry_birth_date_display'] = $this->language->get('entry_birth_date_display');
		$this->data['entry_birth_date_required'] = $this->language->get('entry_birth_date_required');
		$this->data['entry_sex_display'] = $this->language->get('entry_sex_display');
		$this->data['entry_sex_required'] = $this->language->get('entry_sex_required');
		...
		if (isset($this->request->post['ie_display'])) {
			$this->data['ie_display'] = $this->request->post['ie_display'];
		} elseif (!empty($customer_group_info)) {
			$this->data['ie_display'] = $customer_group_info['ie_display'];
		} else {
			$this->data['ie_display'] = '';
		}			
			
		if (isset($this->request->post['ie_required'])) {
			$this->data['ie_required'] = $this->request->post['ie_required'];
		} elseif (!empty($customer_group_info)) {
			$this->data['ie_required'] = $customer_group_info['ie_required'];
		} else {
			$this->data['ie_required'] = '';
		}		
		
		if (isset($this->request->post['rg_display'])) {
			$this->data['rg_display'] = $this->request->post['rg_display'];
		} elseif (!empty($customer_group_info)) {
			$this->data['rg_display'] = $customer_group_info['rg_display'];
		} else {
			$this->data['rg_display'] = '';
		}			
			
		if (isset($this->request->post['rg_required'])) {
			$this->data['rg_required'] = $this->request->post['rg_required'];
		} elseif (!empty($customer_group_info)) {
			$this->data['rg_required'] = $customer_group_info['rg_required'];
		} else {
			$this->data['rg_required'] = '';
		}	
		
		if (isset($this->request->post['birth_date_display'])) {
			$this->data['birth_date_display'] = $this->request->post['birth_date_display'];
		} elseif (!empty($customer_group_info)) {
			$this->data['birth_date_display'] = $customer_group_info['birth_date_display'];
		} else {
			$this->data['birth_date_display'] = '';
		}			
			
		if (isset($this->request->post['birth_date_required'])) {
			$this->data['birth_date_required'] = $this->request->post['birth_date_required'];
		} elseif (!empty($customer_group_info)) {
			$this->data['birth_date_required'] = $customer_group_info['birth_date_required'];
		} else {
			$this->data['birth_date_required'] = '';
		}		
		
		if (isset($this->request->post['sex_display'])) {
			$this->data['sex_display'] = $this->request->post['sex_display'];
		} elseif (!empty($customer_group_info)) {
			$this->data['sex_display'] = $customer_group_info['sex_display'];
		} else {
			$this->data['sex_display'] = '';
		}			
			
		if (isset($this->request->post['sex_required'])) {
			$this->data['sex_required'] = $this->request->post['sex_required'];
		} elseif (!empty($customer_group_info)) {
			$this->data['sex_required'] = $customer_group_info['sex_required'];
		} else {
			$this->data['sex_required'] = '';
		}	
