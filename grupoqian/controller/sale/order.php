...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	public function getForm() {
		...
		if (isset($this->error['payment_complement'])) {
			$this->data['error_payment_complement'] = $this->error['payment_complement'];
		} else {
			$this->data['error_payment_complement'] = '';
		}
		...
		if (isset($this->error['ie'])) {
			$this->data['error_ie'] = $this->error['ie'];
		} else {
			$this->data['error_ie'] = '';
		}
		...
		if (isset($this->error['shipping_number'])) {
			$this->data['error_shipping_number'] = $this->error['shipping_number'];
		} else {
			$this->data['error_shipping_number'] = '';
		}
				
		if (isset($this->error['shipping_complement'])) {
			$this->data['error_shipping_complement'] = $this->error['shipping_complement'];
		} else {
			$this->data['error_shipping_complement'] = '';
		}
    	...
    	if (isset($this->request->post['birth_date'])) {
			...
			$this->data['birth_date'] = $order_info['birth_date'];
		} else {
    	...
    	if (isset($this->request->post['payment_company_id'])) {
			...
			$this->data['payment_company_id'] = $order_info['company_id'];
		} else {
    	...
    	if (isset($this->request->post['payment_tax_id'])) {
			...
			$this->data['payment_tax_id'] = $order_info['tax_id'];
		} else {
      		$this->data['payment_tax_id'] = '';
    	}
		
    	if (isset($this->request->post['payment_ie'])) {
      		$this->data['payment_ie'] = $this->request->post['payment_ie'];
    	} elseif (!empty($order_info)) { 
			$this->data['payment_ie'] = $order_info['ie'];
		} else {
      		$this->data['payment_ie'] = '';
    	}
		
    	if (isset($this->request->post['payment_rg'])) {
      		$this->data['payment_rg'] = $this->request->post['payment_rg'];
    	} elseif (!empty($order_info)) { 
			$this->data['payment_rg'] = $order_info['rg'];
		} else {
      		$this->data['payment_rg'] = '';
    	}
    	...
    	if (isset($this->request->post['payment_number'])) {
			...
			$this->data['payment_number'] = $order_info['payment_number'];
		} else {
      		$this->data['payment_number'] = '';
    	}
		
    	if (isset($this->request->post['payment_complement'])) {
      		$this->data['payment_complement'] = $this->request->post['payment_complement'];
    	} elseif (!empty($order_info)) { 
			$this->data['payment_complement'] = $order_info['payment_complement'];
		} else {
      		$this->data['payment_complement'] = '';
    	}
    	...
    	if (isset($this->request->post['shipping_number'])) {
      		$this->data['shipping_number'] = $this->request->post['shipping_number'];
    	} elseif (!empty($order_info)) { 
			$this->data['shipping_number'] = $order_info['shipping_number'];
		} else {
      		$this->data['shipping_number'] = '';
    	}

    	if (isset($this->request->post['shipping_complement'])) {
      		$this->data['shipping_complement'] = $this->request->post['shipping_complement'];
    	} elseif (!empty($order_info)) { 
			$this->data['shipping_complement'] = $order_info['shipping_complement'];
		} else {
      		$this->data['shipping_complement'] = '';
    	}
  	...
  	private function validateForm() {
		...
		if ($customer_group) {	
			...
			if ($customer_group['company_display'] && $customer_group['company_required'] && !$this->request->post['company']) {
				$this->error['company'] = $this->language->get('error_company_r');
			}
    	...
    	if ((utf8_strlen($this->request->post['payment_number']) < 2) || (utf8_strlen($this->request->post['payment_number']) > 128)) {
      		$this->error['payment_number'] = $this->language->get('error_number');
    	}
		...
		if ($country_info) {
			if ($country_info['postcode_required'] && (utf8_strlen($this->request->post['payment_postcode']) < 9) || (utf8_strlen($this->request->post['payment_postcode']) > 9)) {
		...
		if ($shipping) {
			...
			if ((utf8_strlen($this->request->post['shipping_address_2']) < 3) || (utf8_strlen($this->request->post['shipping_address_2']) > 128)) {
				$this->error['shipping_address_2'] = $this->language->get('error_address_2');
			}
            
			if ((utf8_strlen($this->request->post['shipping_number']) < 2) || (utf8_strlen($this->request->post['shipping_number']) > 128)) {
				$this->error['shipping_number'] = $this->language->get('error_number');
			}
			...
			if ($country_info && $country_info['postcode_required'] && (utf8_strlen($this->request->post['shipping_postcode']) < 9) || (utf8_strlen($this->request->post['shipping_postcode']) > 9)) {
	...
	public function info() {
		...
		if ($order_info) {
            ...
            $this->data['text_ie'] = $this->language->get('text_ie');
			$this->data['text_rg'] = $this->language->get('text_rg');
			$this->data['text_address_1'] = $this->language->get('text_address_1');
            $this->data['text_number'] = $this->language->get('text_number');
            $this->data['text_complement'] = $this->language->get('text_complement');
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$replace = array(
                    ...
                    'complement'=> $order_info['shipping_complement'],
				...
				if ($order_info['payment_address_format']) {
					...
					$format = '{address_1}, ' . '{number}' . ' - {complement},' . "\n" . '{address_2}' . "\n" . '{city}' . "\n" . '{zone}' . "\n" . '{country}' . "\n" . '{postcode}';
				}
				...
				$replace = array(
                    ...
                    'complement'=> $order_info['payment_complement'],
