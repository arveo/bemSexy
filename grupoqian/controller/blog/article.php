...
class ControllerBlogArticle extends Controller {
   ...
   public function insert() {
      ...
      if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
         ...
         $this->redirect($this->url->link('blog/article', 'token=' . $this->session->data['token'], 'SSL')); 
      }
   ...
   private function getList() {
      ...
      $this->data['insert']   = $this->url->link('blog/article/insert', 'token=' . $this->session->data['token'], 'SSL');
      ...
      foreach ($results as $result) {
         ...
         $authorArticle = $this->model_blog_article->getAuthor($article_info['article_id']);
         ...
         $this->data['articles'][] = array(
            ...
            'created'         => date($this->language->get('date_format'), strtotime($article_info['created'])),
