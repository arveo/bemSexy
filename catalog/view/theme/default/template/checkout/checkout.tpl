	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['ie']) {
					$('#payment-address input[name=\'ie\'] + br').after('<span class="error">' + json['error']['ie'] + '</span>');
				}	
				
				if (json['error']['rg']) {
					$('#payment-address input[name=\'rg\'] + br').after('<span class="error">' + json['error']['rg'] + '</span>');
				}	
				
				if (json['error']['sex']) {
					$('#payment-address select[name=\'sex\'] + br').after('<span class="error">' + json['error']['sex'] + '</span>');
				}	
				
				if (json['error']['birth_date']) {
					$('#payment-address input[name=\'birth_date\'] + br').after('<span class="error">' + json['error']['birth_date'] + '</span>');
				}	
				...
				if (json['error']['number']) {
					$('#payment-address input[name=\'number\'] + br').after('<span class="error">' + json['error']['number'] + '</span>');
				}	
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['ie']) {
					$('#payment-address input[name=\'ie\']').after('<span class="error">' + json['error']['ie'] + '</span>');
				}	
				
				if (json['error']['rg']) {
					$('#payment-address input[name=\'rg\']').after('<span class="error">' + json['error']['rg'] + '</span>');
				}	
				...
				if (json['error']['number']) {
					$('#payment-address input[name=\'number\']').after('<span class="error">' + json['error']['number'] + '</span>');
				}	
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['number']) {
					$('#shipping-address input[name=\'number\']').after('<span class="error">' + json['error']['number'] + '</span>');
				}	
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['sex']) {
					$('#payment-address select[name=\'sex\']').after('<span class="error">' + json['error']['sex'] + '</span>');
				}	
