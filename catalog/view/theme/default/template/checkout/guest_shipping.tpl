<table class="form">
  ...
  <tr>
    ...
    <td><input type="text" name="number" value="<?php echo $number; ?>" class="large-field" /></td>
  </tr>
  <td><?php echo $entry_complement; ?></td>
    <td><input type="text" name="complement" value="<?php echo $complement; ?>" class="large-field" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" name="postcode" value="<?php echo $postcode; ?>" class="large-field" id="postcode"/></td>
  </tr>
  <tr>
