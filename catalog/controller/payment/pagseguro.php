	   	...
	   	if ($this->cart->hasShipping()) {
			...
			$paymentRequest->setShippingAddress(  
				...
				Array(  
					...
					'number' 	=> $order_info['shipping_number'], // Não há este campo no OpenCart

					'complement'=> $order_info['shipping_complement'], // Não há este campo no OpenCart
			...
			$paymentRequest->setShippingAddress(  
				...
				Array(  
					...
					'number' 	=> $order_info['payment_number'], // Não há este campo no OpenCart

					'complement'=> $order_info['payment_complement'], // Não há este campo no OpenCart
