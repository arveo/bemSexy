		...
		if ($this->user->isLogged() && $this->user->hasPermission('modify', 'sale/order')) {	
			...
			if ($this->cart->hasShipping()) {		
				...
				if (!isset($json['error']['shipping'])) {
					...
					$address_data = array(
                        ...
                        'number'         => $this->request->post['shipping_number'],
                        'complement'     => $this->request->post['shipping_complement'],                                                
			...
			if (!isset($json['error']['payment'])) {
				...
				$address_data = array(
                    ...
                    'number'         => $this->request->post['payment_number'],
                    'complement'     => $this->request->post['payment_complement'],                                        
